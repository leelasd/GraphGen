...
_import_map = {
    ...
    "ChemistryAtomicGenerator": ".generator",
    "ChemistryFillInBlankGenerator": ".generator",
    "ChemistryLogdCotGenerator": ".generator",
    "ChemistryLogdPredictionGenerator": ".generator",
    "ChemistryMultiAnswerGenerator": ".generator",
    "ChemistryMultiChoiceGenerator": ".generator",
    "ChemistryTrueFalseGenerator": ".generator",
    "CoTGenerator": ".generator",
    "FillInBlankGenerator": ".generator",
    "MatchedMolecularPairGenerator": ".generator",
    "MultiAnswerGenerator": ".generator",
    "MultiChoiceGenerator": ".generator",
    "MultiHopGenerator": ".generator",
    "PairwisePreferenceGenerator": ".generator",
